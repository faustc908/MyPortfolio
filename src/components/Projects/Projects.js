    ...
    return (
        <div>
            ...
            <div className='projects'>
                ...
                <p>A full stack application using the PERN (React.js, Node.js, PostgreSQL, Express) stack to create an app that lets you calculate your expenses as well as leave notes on different deals and nuances in expenditures.  Tested with Jest, Supertest, and Enzyme.  This application was developed with the financial hardship covid-19 has placed on people and should be a useful tool.</p>
                <div>
